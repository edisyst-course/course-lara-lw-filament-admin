...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        $product = Product::create(['name' => 'Prodotto 1', 'slug' => 'prodotto-1', 'price' => 2999, 'category_id' => 1]);
        $tags = \App\Models\Tag::all();
            $product->tags()->attach(
                $tags->random(rand(1, 3))->pluck('id')->toArray()
            );

        Product::create(['name' => 'Prodotto 2', 'slug' => 'prodotto-2', 'price' => 3999, 'category_id' => 1]);
        Product::create(['name' => 'Prodotto 3', 'slug' => 'prodotto-3', 'price' => 4999, 'category_id' => 1]);
